...
class CollectionsPagination extends StatelessWidget {
  final int pageCount;
  final int page;
  final ValueChanged<int> onPage;

  const CollectionsPagination({Key? key, required this.pageCount, required this.page, required this.onPage}) : super(key: key);
