...
/// Small test helper to prevent widget tests from attempting real HTTP
/// for `Image.network`. Installs an [HttpOverrides] that returns a
/// tiny 1x1 transparent PNG for any network request.
...
class _FakeHttpClientRequest implements HttpClientRequest {
	...
	// Allow other members to fall back to noSuchMethod to keep this helper small.
	@override
